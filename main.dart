...
class TournamentStorage {
  ...
  static void load() {
    try {
      _lastFreeEntry = html.window.localStorage['bjTournFree'] ?? '';
    } catch (_) {}
  }
...
const List<PlayerLevel> kLevels = [
  ...
  PlayerLevel(2,  'Apprentice',   100,    Color(0xFF90A4AE)),
  PlayerLevel(3,  'Dealer',       250,    Color(0xFF80CBC4)),
  PlayerLevel(4,  'Sharp',        500,    Color(0xFF4CAF50)),
  PlayerLevel(5,  'Hustler',      900,    Color(0xFF26A69A)),
  PlayerLevel(6,  'Pro',          1400,   Color(0xFF42A5F5)),
  PlayerLevel(7,  'Shark',        2100,   Color(0xFF1E88E5)),
  PlayerLevel(8,  'High Roller',  3000,   Color(0xFF7E57C2)),
  PlayerLevel(9,  'Whale',        4200,   Color(0xFF9C27B0)),
  PlayerLevel(10, 'Legend',       6000,   Color(0xFFFFD700)),
  PlayerLevel(11, 'Myth',         8500,   Color(0xFFFF9800)),
  PlayerLevel(12, 'Ghost',        12000,  Color(0xFF00BCD4)),
  PlayerLevel(13, 'Phantom',      16000,  Color(0xFFE91E63)),
  PlayerLevel(14, 'Maestro',      21000,  Color(0xFFF44336)),
  PlayerLevel(15, 'Godfather',    27000,  Color(0xFFD4AF37)),
  PlayerLevel(16, 'Immortal',     50000,  Color(0xFF00E5FF)),
  PlayerLevel(17, 'The House',    100000, Color(0xFFFFFFFF)),
];
...
const List<Badge> kBadges = [
  Badge('first_win',      'First Blood',        'Win your first hand',                    '🩸'),
  Badge('first_triple',   'Triple Threat',      'Win all 3 hands in one round',           '🎯'),
  Badge('rounds_10',      'Getting Warmed Up',  'Play 10 rounds',                         '🔥'),
  Badge('rounds_50',      'Regular',            'Play 50 rounds',                         '🃏'),
  Badge('rounds_100',     'Veteran',            'Play 100 rounds',                        '⚔️'),
  Badge('streak_3',       'Hot Hand',           'Win 3 hands in a row',                   '🌶️'),
  Badge('streak_5',       'On Fire',            'Win 5 hands in a row',                   '🔥'),
  Badge('streak_10',      'Unstoppable',        'Win 10 hands in a row',                  '💫'),
  Badge('side_bet',       'Side Hustler',       'Hit a side bet',                         '💜'),
  Badge('broke',          'Busted',             'Run out of chips',                       '💸'),
  Badge('comeback',       'Comeback Kid',       'Win after dropping below \$100',         '💪'),
  Badge('big_spender',    'Big Spender',        'Bet \$500+ in a single round',           '💵'),
  ...
  // ── Legendary — takes a year of consistent play ──────────────
  Badge('night_owl',      'Night Owl',          'Play 1,000 rounds',                      '🌙'),
  ...
  Badge('triple_master',  'Triple Threat Master', 'Win all 3 hands 100 times',            '🎰'),
];
...
class PlayerStorage {
  ...
  static List<String> checkAndAwardBadges({
    ...
    // Standard badges
    check('first_win', justWon && totalWins >= 1);
  ...
  static void scheduleDailyBonusReminder() {
    try {
      ...
      js.context.callMethod('eval', [
        "clearTimeout(window._bt);window._bt=setTimeout(function(){if(Notification.permission==='granted'){new Notification('Triple Threat Blackjack',{body:'Your daily bonus is ready!'});}},\$ms);"
      ]);
    } catch (_) {}
  }
}
...
class ShareHelper {
  ...
  static String friendReferral(String playerCode) =>
      ...
      'Enter my code to add me as a friend and we BOTH get \$5,000 FREE chips!\n\n'
      'My code: $playerCode\n\n'
              ...
              child: Container(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  const Text('By continuing you agree to our Terms & Privacy Policy',
                    textAlign: TextAlign.center, style: TextStyle(color: Color(0x30FFFFFF), fontSize: 8)),
                ]),
              ),
            ),
          )),
          ...
          FadeTransition(opacity: _fade,
            child: Center(child: Container(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                const SizedBox(height: 16),
                const Text('\$2,000 FREE CHIPS WAITING FOR YOU',
        ...
        child: Stack(children: [
          ...
          Center(child: FadeTransition(opacity: _fade, child: ScaleTransition(scale: _scale,
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              const SizedBox(height: 16),
              const Text('\$2,000 FREE CHIPS TO START', style: TextStyle(color: Color(0x70D4AF37), fontSize: 9, letterSpacing: 3, fontWeight: FontWeight.w600)),
              const SizedBox(height: 8),
              const Text('Triple Threat Blackjack  •  7 Decks  •  Split  •  Insurance', style: TextStyle(color: Color(0x40FFFFFF), fontSize: 8, letterSpacing: 1)),
            ]),
          ))),
          // Daily bonus overlay
...
class _AnimCardState extends State<AnimCard> with SingleTickerProviderStateMixin {
  ...
  Widget _buildCard() {
    ...
    return Container(width: widget.w, height: widget.h,
      ...
      child: Stack(children: [
        Positioned(top: 3, left: 4, child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
...
class _GameScreenState extends State<GameScreen> {
  ...
  void initState() {
    ...
    if (widget.tournamentBalance != null) {
      ...
      balance = saved > 0 ? saved + bonus : 2000 + bonus;
  ...
  void runDealer() {
    ...
    void step() {
      if (handValue(dd) < 17 && rem.isNotEmpty) {
  ...
  void finishRound(List<PlayingCard> dc) {
    ...
    if (wins == 3) pay += bet * 3; else if (wins == 2) pay += bet;
      ...
      builder: (BuildContext ctx) => Center(
        child: Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            const SizedBox(height: 12),
            _menuBtn(Icons.workspace_premium, 'VIP STATUS', () {
              Navigator.pop(ctx);
              Navigator.of(context).push(MaterialPageRoute(
        ...
        const Spacer(),
          ...
          if (balance < 300) GestureDetector(
            ...
            child: Container(
              ...
              child: Text(balance < 100 ? 'LOW CHIPS — ADD MORE' : 'ADD CHIPS',
  ...
  Widget _betPhase() {
    return Column(children: [
      Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
        Container(
          padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
          decoration: BoxDecoration(color: const Color(0x20D4AF37), borderRadius: BorderRadius.circular(10),
              border: Border.all(color: const Color(0x40D4AF37))),
          child: Column(children: [
            const Text('BET × 3', style: TextStyle(color: Color(0xFFD4AF37), fontSize: 7, letterSpacing: 2, fontWeight: FontWeight.w700)),
            Text(fmtMoney(bet * 3), style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w900)),
          ])),
        const SizedBox(width: 8),
        if (sideBet > 0) Container(
          padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
          decoration: BoxDecoration(color: const Color(0x206A1B9A), borderRadius: BorderRadius.circular(10),
              border: Border.all(color: const Color(0x406A1B9A))),
          child: Column(children: [
            const Text('SIDE', style: TextStyle(color: Color(0xFFCE93D8), fontSize: 7, letterSpacing: 2, fontWeight: FontWeight.w700)),
            Text(fmtMoney(sideBet), style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w900)),
          ])),
        const Spacer(),
        Row(children: [
          _dealButton(),
          if (balance < 500) ...[
            ...
            GestureDetector(
              onTap: () => setState(() => showChipStore = true),
              child: Container(height: 48, width: 52,
                decoration: BoxDecoration(
                  gradient: const LinearGradient(colors: [Color(0xFF1565C0), Color(0xFF0D47A1)]),
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(color: const Color(0x60FFFFFF), width: 1)),
                child: const Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  Text('+', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w900, height: 1)),
                  Text('CHIPS', style: TextStyle(color: Colors.white70, fontSize: 7, fontWeight: FontWeight.w700)),
                ]))),
          ],
        ]),
      ]),
      const SizedBox(height: 8),
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        ...[1, 5, 25, 100, 500].map((v) => _chipBtn(v, selChip == v, () {
          setState(() { selChip = v; if (balance >= (bet + v) * 3 + sideBet) bet += v; }); SoundEngine.chipPlace();
        })),
        const SizedBox(width: 8),
        GestureDetector(onTap: () => setState(() => bet = 0),
          child: Container(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 8),
            decoration: BoxDecoration(color: const Color(0x40000000), borderRadius: BorderRadius.circular(8),
                border: Border.all(color: const Color(0x40FFFFFF))),
            child: const Text('CLR', style: TextStyle(color: Colors.grey, fontWeight: FontWeight.w700, fontSize: 11)))),
        const SizedBox(width: 4),
        ...[1, 5, 25, 100, 500].map((v) => _chipBtn(v, false, () {
          setState(() { if (balance >= bet * 3 + sideBet + v) { sideBet += v; SoundEngine.chipPlace(); } });
        })),
        const SizedBox(width: 8),
        GestureDetector(onTap: () => setState(() => sideBet = 0),
          child: Container(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 8),
            decoration: BoxDecoration(color: const Color(0x40000000), borderRadius: BorderRadius.circular(8),
                border: Border.all(color: const Color(0x40FFFFFF))),
            child: const Text('CLR', style: TextStyle(color: Colors.grey, fontWeight: FontWeight.w700, fontSize: 11)))),
  ...
  Widget _chipStoreOverlay() {
    final pkgs = [
      {'chips': 1000, 'price': 'FREE', 'color': const Color(0xFF2E7D32), 'label': 'Starter'},
      {'chips': 5000, 'price': '\$0.99', 'color': const Color(0xFF1565C0), 'label': 'Popular'},
      {'chips': 15000, 'price': '\$1.99', 'color': const Color(0xFF6A1B9A), 'label': 'Value'},
      {'chips': 50000, 'price': '\$4.99', 'color': const Color(0xFFB8860C), 'label': 'High Roller'},
    ];
...
class TournamentLobbyScreen extends StatefulWidget {
  ...
  const TournamentLobbyScreen({super.key, required this.playerBalance, required this.onChipsChanged});
  @override State<TournamentLobbyScreen> createState() => _TournamentLobbyScreenState();
}

class _TournamentLobbyScreenState extends State<TournamentLobbyScreen> {
  late int _balance;

  @override void initState() { super.initState(); _balance = widget.playerBalance; }
                          ...
                          decoration: BoxDecoration(
                            gradient: canEnter
                              ? const LinearGradient(
                                  ...
                                  begin: Alignment.topCenter, end: Alignment.bottomCenter)
                              : null,
                            color: canEnter ? null : const Color(0x20FFFFFF),
                            borderRadius: BorderRadius.circular(24),
                            boxShadow: canEnter ? const [
                              BoxShadow(color: Color(0x80D4AF37), blurRadius: 12)] : [],
                          ),
                          child: Center(child: Text(
                            isFree
                              ? (TournamentStorage.canEnterFree() ? 'ENTER FREE' : 'USED TODAY')
                              : canEnter
                                  ? 'ENTER — ${fmtMoney(t.entryFee)}'
                                  : 'NEED ${fmtMoney(t.entryFee)}',
                            style: TextStyle(
                              color: canEnter ? Colors.black : Colors.white38,
...
class _TournamentGameScreenState extends State<TournamentGameScreen> {
  ...
  void initState() {
    super.initState();
    _balance = widget.config.startingChips;
  ...
  void _endTournament() {
    ...
    _timer.cancel();
    Navigator.of(context).pushReplacement(MaterialPageRoute(
      builder: (BuildContext _) => TournamentResultsScreen(
        config: widget.config,
        playerBalance: _balance,
        onDone: (int finalChips) {
          widget.onComplete(widget.playerBalance + finalChips);
          Navigator.of(context).pop();
        },
      ),
    ));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(children: [
        // Embed the full game — pass tournament balance
        _TournamentGameEmbed(
          startingBalance: _balance,
          onBalanceChanged: (int b) => setState(() => _balance = b),
        ),
        // Tournament HUD overlay at top
            ...
            child: Row(children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0x40D4AF37))),
                child: Row(children: [
                  Text(widget.config.emoji, style: const TextStyle(fontSize: 12)),
                  const SizedBox(width: 4),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(10),
                  border: Border.all(color: _timerColor.withOpacity(0.6), width: 1.5),
                  boxShadow: _secondsLeft <= 30 ? [
                    BoxShadow(color: _timerColor.withOpacity(0.4), blurRadius: 8)
                  ] : [],
                ),
                child: Row(children: [
              ...
              GestureDetector(
                onTap: () => showDialog(
                  ...
                  builder: (BuildContext ctx) => AlertDialog(
                    ...
                    content: const Text('Your current balance will be your final score.',
                        style: TextStyle(color: Colors.white70)),
                    actions: [
                      TextButton(onPressed: () => Navigator.pop(ctx),
                          child: const Text('KEEP PLAYING', style: TextStyle(color: Color(0xFFD4AF37)))),
                      TextButton(onPressed: () { Navigator.pop(ctx); _endTournament(); },
                          child: const Text('END NOW', style: TextStyle(color: Color(0xFFEF5350)))),
                    ],
                  ),
                ),
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: const Color(0x40000000),
                    borderRadius: BorderRadius.circular(8),
                    border: Border.all(color: const Color(0x40EF5350))),
...
// Embedded game widget for tournament — simplified version of GameScreen
class _TournamentGameEmbed extends StatefulWidget {
  final int startingBalance;
  final Function(int) onBalanceChanged;
  const _TournamentGameEmbed({required this.startingBalance, required this.onBalanceChanged});
  @override State<_TournamentGameEmbed> createState() => _TournamentGameEmbedState();
}

class _TournamentGameEmbedState extends State<_TournamentGameEmbed> {
  @override
  Widget build(BuildContext context) {
    // Use a full GameScreen but with tournament balance
    return GameScreen(tournamentBalance: widget.startingBalance,
        onBalanceUpdate: widget.onBalanceChanged);
  }
}
...
class TournamentResultsScreen extends StatefulWidget {
  ...
  const TournamentResultsScreen({super.key, required this.config,
      required this.playerBalance, required this.onDone});
  @override State<TournamentResultsScreen> createState() => _TournamentResultsScreenState();
}
...
class _TournamentResultsScreenState extends State<TournamentResultsScreen>
  ...
  late AnimationController _ctrl;
  late Animation<double> _fade, _scale;
  late List<TournamentEntry> _results;
  ...
  void initState() {
    ...
    _scale = Tween<double>(begin: 0.8, end: 1).animate(
        CurvedAnimation(parent: _ctrl, curve: Curves.easeOutBack));
    _results = TournamentStorage.generateResults(
      PlayerStorage.playerName, PlayerStorage.avatarIndex,
      widget.playerBalance, widget.config);
    _playerRank = _results.indexWhere((e) => e.name == PlayerStorage.playerName) + 1;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        ...
        child: Stack(children: [
          Positioned.fill(child: CustomPaint(painter: FeltPainter())),
          SafeArea(child: FadeTransition(opacity: _fade, child: ScaleTransition(scale: _scale,
            child: Column(children: [
              const SizedBox(height: 20),
              // Result header
              ...
              const Text('TOURNAMENT COMPLETE', style: TextStyle(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(20),
                  border: Border.all(
                    color: isTop3 ? const Color(0xFFD4AF37) : const Color(0x40FFFFFF),
                    width: isTop3 ? 2 : 1),
                  boxShadow: isTop3 ? const [
                    BoxShadow(color: Color(0x60D4AF37), blurRadius: 20)] : [],
                ),
                child: Column(children: [
                  Text(isTop3 ? medals[_playerRank - 1] : '#$_playerRank',
                      style: TextStyle(fontSize: isTop3 ? 40 : 24,
                          color: const Color(0xFFD4AF37))),
                  const SizedBox(height: 8),
                  Text('YOUR FINAL BALANCE', style: const TextStyle(
                      color: Colors.white54, fontSize: 9, letterSpacing: 2)),
                  Text(fmtMoney(widget.playerBalance), style: const TextStyle(
                  ...
                  Container(
                    ...
                    child: Column(children: [
                      ...
                      Text('+${fmtMoney(_prize)}', style: const TextStyle(
                          color: Color(0xFFFFD700), fontSize: 28,
                          fontWeight: FontWeight.w900)),
                      const Text('chips added to balance', style: TextStyle(
                  ...
                  if (_playerRank <= 3) ...[
                    ...
                    Builder(builder: (BuildContext ctx) =>
                      ShareHelper.shareBtn(ctx,
                        ShareHelper.tournamentWin(widget.config.name, _playerRank, _prize),
              ...
              Expanded(child: ListView.builder(
                ...
                itemBuilder: (BuildContext ctx, int i) {
                  final e = _results[i];
                  final isMe = e.name == PlayerStorage.playerName;
                  return Container(
                    margin: const EdgeInsets.only(bottom: 6),
                    padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 10),
                    decoration: BoxDecoration(
                      color: isMe ? const Color(0x20D4AF37) : const Color(0x08FFFFFF),
                      borderRadius: BorderRadius.circular(10),
                      border: Border.all(
                        color: isMe ? const Color(0x80D4AF37) : const Color(0x20FFFFFF))),
                    child: Row(children: [
                      SizedBox(width: 32, child: Center(child: i < 3
                        ? Text(medals[i], style: const TextStyle(fontSize: 16))
                        : Text('#${i+1}', style: const TextStyle(
                            color: Color(0x70D4AF37), fontSize: 12,
                            fontWeight: FontWeight.w800)))),
                      const SizedBox(width: 8),
                      Container(
                        width: 28, height: 28,
                      ...
                      Expanded(child: Text(e.name, style: TextStyle(
                          color: isMe ? const Color(0xFFD4AF37) : Colors.white,
                          fontSize: 12, fontWeight: isMe ? FontWeight.w900 : FontWeight.w500))),
                      Text(fmtMoney(e.finalBalance), style: const TextStyle(
                          color: Color(0xFFD4AF37), fontSize: 13, fontWeight: FontWeight.w900)),
                    ]),
                  );
                },
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: const [BoxShadow(
                          color: Color(0xAAD4AF37), blurRadius: 16, offset: Offset(0, 4))]),
                    child: Center(child: Text('CLAIM +${fmtMoney(_prize)}',
        ...
        child: Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            ShaderMask(
              shaderCallback: (b) => const LinearGradient(
                colors: [Color(0xFFFFD700), Color(0xFFD4AF37)]).createShader(b),
              child: const Text('+\$5,000', style: TextStyle(
                    ...
                    Container(
                      ...
                      child: const Column(
                        ...
                        Text('3. You do the same with their code',
                            style: TextStyle(color: Colors.white60, fontSize: 10)),
                        Text('4. Both players get +\$5,000 chips! 🎉',
  ...
  Widget _myCodeCard(String myCode, String shareCode) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        const SizedBox(height: 6),
        const Text('Share to get +\$5,000 chips when friends add your code!',
            textAlign: TextAlign.center,
